  ...
  return(
    <div>
      ...
      <div style={{maxWidth:"70vw",paddingLeft:"1vw"}}>
        ...
        />
          Stump the Street is where new investors and seasoned pros come to challenge their peers and walk away with prizes. Select your own winning portfolios and watch your Global Rank soar.
        </p>
      </div>
    </div>
  )
